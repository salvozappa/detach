...
Detach.it uses secure token-based authentication for pairing devices with your instance. The token is auto-generated on first startup and displayed in the logs with a QR code for easy mobile pairing.
